...
const CACHE="mediatheque-pwa-v12";
const FILES=["./","./index.html","./style.css","./app.js","./manifest.json","./assets/logo-boris-vian.png","./assets/logo-boris-vian-icon-192.png","./assets/logo-boris-vian-icon-96.png"];
